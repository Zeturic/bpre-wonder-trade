...
CFLAGS = -O2 -mlong-calls -Wall -Wextra -mthumb -mno-thumb-interwork -fno-inline -fno-builtin -std=gnu11 -mabi=apcs-gnu -mcpu=arm7tdmi -march=armv4t -mtune=arm7tdmi -c -I include -Wa,--defsym,SPECIAL_WonderTradeGenerateMon=$(SPECIAL_WonderTradeGenerateMon)
...
ARMIPS ?= armips
ARMIPS_FLAGS = -sym test.sym -equ SPECIAL_WonderTradeGenerateMon $(SPECIAL_WonderTradeGenerateMon)
